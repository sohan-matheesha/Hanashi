    ...
    <div className="min-h-screen bg-[#fafafc] px-6 py-8 md:px-10">
      <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-gray-500">
            Learn Japanese through structured video lessons. You can add lesson
            videos here later for Hiragana, Katakana, Grammar, Vocabulary, and
            Speaking Practice.
          </p>
        </div>

        <button className="inline-flex items-center justify-center gap-2 rounded-full bg-[#202c5c] px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-[#c77d9b]">
      ...
      <div className="mb-8 grid gap-4 md:grid-cols-3">
        <div className="rounded-3xl border border-pink-100 bg-white p-5 shadow-sm">
          ...
          <p className="mt-4 text-sm text-gray-500">Total Videos</p>
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        {videoLessons.map((lesson) => (
          <div
            key={lesson.id}
            className="group overflow-hidden rounded-4xl border border-gray-100 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
          >
            <div className="relative h-52 overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <button className="flex h-16 w-16 items-center justify-center rounded-full bg-white/90 text-[#202c5c] shadow-lg transition hover:scale-110">
            ...
            <div className="p-6">
              ...
              <button className="mt-5 w-full rounded-full bg-[#202c5c] px-5 py-3 text-sm font-bold text-white transition hover:bg-[#c77d9b]">
                Watch Lesson
              </button>
            </div>
          </div>
      ...
      <div className="mt-8 rounded-4xl border border-dashed border-pink-200 bg-white p-6 text-center">
        <h3 className="text-xl font-extrabold text-[#202c5c]">
          Ready for your own lesson videos
        </h3>
        <p className="mx-auto mt-2 max-w-2xl text-sm leading-6 text-gray-500">
          Later, you can connect this page with Supabase or admin panel so
          teachers/admins can upload video title, description, thumbnail, and
          YouTube/embed link.
        </p>
      </div>
    </div>
